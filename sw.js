/* witsahead.org offline layer, version 202609261222. Pages and data: network first, cached copy when offline.
   Assets: cache first. Nothing is cached from other origins except the fonts. The visitor counter is never cached. */
var V='wa-202609261222', PAGES=["/", "/news/", "/projects/", "/news.json", "/offline/", "/assets/favicon.svg", "/assets/app-icon-192.png", "/fr/", "/fr/news/", "/fr/news.json", "/es/", "/es/news/", "/es/news.json", "/pt/", "/pt/news/", "/pt/news.json", "/zh/", "/zh/news/", "/zh/news.json", "/zu/", "/zu/news/", "/zu/news.json", "/yo/", "/yo/news/", "/yo/news.json", "/pcm/", "/pcm/news/", "/pcm/news.json"];
