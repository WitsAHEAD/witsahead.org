/* witsahead.org offline layer, version 202609150558. Pages and data: network first, cached copy when offline.
   Assets: cache first. Nothing is cached from other origins except the fonts. The visitor counter is never cached. */
var V='wa-202609150558', PAGES=["/", "/news/", "/projects/", "/fr/", "/fr/news/", "/news.json", "/fr/news.json", "/offline/", "/assets/favicon.svg", "/assets/app-icon-192.png"];
